...
// ===================================
// MULTI-ELDERLY DATA STRUCTURE
// ===================================

// Color coding for each elderly
const elderlyColors = {
    1: '#3B82F6',  // Blue
    2: '#8B5CF6',  // Purple
    3: '#14B8A6',  // Teal
...
const elderlyList = [
    {
        ...
        vitals: {
            ...
            bloodSugar: { current: 5.8, normal: [4.0, 6.0], unit: 'mmol/L', status: 'normal' },
            temperature: { current: 36.8, normal: [36.1, 37.2], unit: '°C', status: 'normal' }
        },
        activity: {
            steps: 2847,
            stepGoal: 5000,
    ...
    },
    {
        ...
        vitals: {
            ...
            bloodSugar: { current: 5.2, normal: [4.0, 6.0], unit: 'mmol/L', status: 'normal' },
            temperature: { current: 36.6, normal: [36.1, 37.2], unit: '°C', status: 'normal' }
        },
        activity: {
            steps: 3124,
            stepGoal: 5000,
    ...
    },
    {
        ...
        personal: {
            ...
            age: 81,
            room: 'A-205',
            color: elderlyColors[3],
            wristbandId: 'WB-003',
            conditions: ['Heart Disease', 'Diabetes']
        },
        vitals: {
            heartRate: { current: 78, normal: [60, 100], unit: 'bpm', status: 'warning' },
            bloodPressure: { systolic: 135, diastolic: 88, unit: 'mmHg', status: 'warning' },
            bloodSugar: { current: 6.5, normal: [4.0, 6.0], unit: 'mmol/L', status: 'warning' },
            temperature: { current: 36.9, normal: [36.1, 37.2], unit: '°C', status: 'normal' }
        },
        activity: {
            steps: 1823,
            stepGoal: 5000,
        ...
        alerts: ['High BP detected', 'Low activity today']
    },
    {
        id: 4,
        personal: {
        ...
        vitals: {
            ...
            bloodSugar: { current: 5.5, normal: [4.0, 6.0], unit: 'mmol/L', status: 'normal' },
            temperature: { current: 37.0, normal: [36.1, 37.2], unit: '°C', status: 'normal' }
        },
        activity: {
            steps: 2456,
            stepGoal: 5000,
...
// Legacy single elderly data (for backward compatibility)
const elderlyData = elderlyList[0];
